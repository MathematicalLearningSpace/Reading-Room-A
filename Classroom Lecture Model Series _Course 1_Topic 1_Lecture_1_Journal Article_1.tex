...
\begin{document}
\begin{frontmatter}
		\title{Course 1 Lecture 1 Journal Article 1:  DRAFT Sample: DNA Shape Categories for Statistical Learning Models of Gene Overexpression, Amplification and Mutation in GastroIntestinal Cancers}
