...
\frac{dx}{dt} = g(t,x(t))
\end{equation}
with an initial point in the domain of $g$ $(t_0, x_0) \in \Omega$.  Furthermore, let G be a vector field with a vector value function $(g_1,g_2,...,g_n)$ for $(x_{1}(t),x_{2}(t),...,x_{n}(t))$ with a vector of time based derivatives
\begin{equation}
\mathbf{x}'(t)=
\begin{cases}
