...
\subsection{Hepatocellular carcinoma (HCC)}

\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{HCC.png} 
\end{minipage}\hfill
\caption{(a) HCC}
\label{fig:Figure2}
\end{figure} 

\subsection{Signaling Networks: Mutations}
\centering	
\begin{table}[H]\tiny
	\caption{}	
	\begin{tabular}{rp{1cm}|p{4cm}|}
		\hline	
		Network & Description & Citation \\
		\hline 
		Mutation-activated MET to RAS-ERK & & \cite{key400} \\
		Mutation-activated MET to PI3K & & \cite{key400} \\
		Mutation-activated PI3K to PI3K & & \cite{key400} \\
		Mutation-activated CTNNB1 to Wnt & & \cite{key400} \\
		Mutation-activated NRF2 to KEAP1-NRF2 & & \cite{key400} \\
		\hline
		Mutation-inactivated AXIN to Wnt  & & \cite{key400} \\
		Mutation-inactivated KEAP1 to KEAP1-NRF2 & & \cite{key400} \\
		Mutation-inactivated PTEN to PI3K & & \cite{key400} \\
		\hline
		Mutation-inactivated TP53 to transcription & & \cite{key400} \\
	\end{tabular}
\end{table}	

\subsection{Signaling Networks: Overexpression}
...
\begin{table}[H]\tiny
	...
	\begin{tabular}{rp{1cm}|p{4cm}|}
		\hline	
		FZD7-overexpression to Wnt  & & \cite{key400} \\
		TGFA-overexpression to PLCG-PKC  & & \cite{key400} \\
		\hline
		TGFA-overexpression to RAS-ERK  & & \cite{key400} \\
		IGF1R-overexpression to RAS-ERK  & & \cite{key400} \\
		IGF2-overexpression to RAS-ERK  & & \cite{key400} \\
		HGF-overexpression to RAS-ERK  & & \cite{key400} \\
		MET-overexpression to RAS-ERK  & & \cite{key400} \\
		\hline
		TGFA-overexpression to PI3K   & & \cite{key400} \\
		IGF2-overexpression to PI3K  & & \cite{key400} \\
		IGF1R-overexpression to PI3K  & & \cite{key400} \\
		MET-overexpression to PI3K  & & \cite{key400} \\
		HGF-overexpression to PI3K  & & \cite{key400} \\		
		\hline
		TERT-overexpression to telomerase activity  & & \cite{key400} \\
		TGFBR2-reduced expression to TGF-beta  & & \cite{key400} \\
		\hline 
	\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Apelin.png} 
\end{minipage}\hfill
\caption{(a) Apelin}
\label{fig:Figure2}
\end{figure} 
...
\hline 
TGFA & (overexpression) & \cite{key400} \\
IGF2 & (overexpression) & \cite{key400} \\
IGF1R & (overexpression) & \cite{key400} \\
MYC  & (amplification) & \cite{key400} \\
RB1  & (loss)  & \cite{key400} \\
TERT  & (overexpression) & \cite{key400} \\
TP53  & (mutation) & \cite{key400} \\
p16  & (deletion)  & \cite{key400} \\
PTEN  & (mutation) & \cite{key400} \\
TGFBR2 & (reduced expression) & \cite{key400} \\ 
FZD7  & (overexpression) & \cite{key400} \\
CTNNB1 & (mutation) & \cite{key400} \\
AXIN1 & (mutation) & \cite{key400} \\
KEAP1 &  (mutation) & \cite{key400} \\
NFE2L2 & (mutation) & \cite{key400} \\
HGF & (overexpression) & \cite{key400} \\
MET & (mutation, overexpression) & \cite{key400} \\
PIK3CA & (mutation) & \cite{key400} \\
ARID1A & (mutation) & \cite{key400} \\
ARID2 & (mutation) & \cite{key400} \\
\hline 
\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Hippo.png} 
\end{minipage}\hfill
\caption{(a) Hippo}
\label{fig:Figure2}
\end{figure} 
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{JakSTAT.png} 
\end{minipage}\hfill
\caption{(a) JakSTAT}
\label{fig:Figure2}
\end{figure} 
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{WDR.png} 
\end{minipage}\hfill
\caption{(a) WDR}
\label{fig:Figure2}
\end{figure} 
...
\section{Algorithms: Differential Equations I}
...
\begin{algorithm}[H]
	...
	\State 
	\end{algorithmic}
	\caption{Differential Equations I}\label{DE_I_1}
\end{algorithm}
