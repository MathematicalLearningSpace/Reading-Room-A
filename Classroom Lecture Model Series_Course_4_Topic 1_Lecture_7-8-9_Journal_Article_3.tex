...
\scriptsize
\begin{frontmatter}
		\title{DRAFT Sample: Energy Tracking Operators for Amplitude and Frequency Modulation in Multi-Instrument Jazz Compositions}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_1.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_2.png}
	\end{minipage}\hfill	
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_3.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_4.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_5.png}
	\end{minipage}\hfill	
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_6.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_7.png}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_8.png}
	\end{minipage}\hfill	
	\begin{minipage}[b]{0.3\linewidth}
		%\includegraphics[scale=0.15]{Example_3_Figure_9.png}
	\end{minipage}\hfill
	\caption{(a)}
	\label{fig:Figure1}
\end{figure} 
