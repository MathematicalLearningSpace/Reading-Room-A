...
\scriptsize
\begin{frontmatter}
		\title{DRAFT Sample: A Mathematical Model of Ribosome Model with Circular mRNA}
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Network_3.png} 
\end{minipage}\hfill
\caption{(a) Network 3}
\label{fig:Figure2}
\end{figure} 
...
\section{Molecular Interactions and Descriptions}
...
\section{Interaction Diagram and Annotations}
...
Table 1 shows the overall molecular descriptors

\begin{table}[htbp]
	\centering
	\caption{Molecular descriptors \cite{key1}}
	\scriptsize{
...
\subsection{Level 1: DNA-DNA interaction}

\subsubsection{Interaction Diagram and Annotations}
...
\subsection{Level 2: DNA-protein interaction}
...
\subsection{Level 3: DNA-Compound interaction}
...
\subsection{Level 4: Protein-Compound interaction}
...
\subsection{Level 5: Protein-Protein interaction} 
...
\subsection{Level 6: Compound-Compound interaction} 
