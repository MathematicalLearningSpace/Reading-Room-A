...
\includegraphics[scale=0.40]{Metabolism.png} 
\end{minipage}\hfill
\caption{(a) Metabolism}
\label{fig:Figure1}
\end{figure} 
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Metabolism_1.png} 
\end{minipage}\hfill
\caption{(a) Metabolism 1}
\label{fig:Figure2}
\end{figure} 
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Obesity_1.png} 
\end{minipage}\hfill
\caption{(a) Obesity 1}
\label{fig:Figure2}
\end{figure} 
...
\begin{figure}[H]
\begin{minipage}[b]{0.3\linewidth}
\includegraphics[scale=0.40]{Pancreatic_Signaling.png} 
\end{minipage}\hfill
\caption{(a) Pancreatic Signaling}
\label{fig:Figure2}
\end{figure} 
